...
- 관련 문서:
  - `BACKEND.md`
  - `backend/docs/architecture/package-and-wiring.md`
  - `backend/core/docs/domain-modeling-rules.md`
  - `backend/storage/docs/persistence-rules.md`
  - `backend/docs/code-quality/clean-code-responsibility.md`
