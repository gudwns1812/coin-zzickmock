    ...
    private String generateOtp() {
        ...
        try {
            ...
            if (code == null || code.isBlank()) {
                throw new CoreException(ExternalErrorType.KRX_OTP_GENERATION_FAILED);
            }
            return code;
        } catch (RestClientException exception) {
            throw new CoreException(ExternalErrorType.KRX_OTP_GENERATION_FAILED, exception);
        }
    }
    ...
    private String requestHolidayData(int year, String code) {
        ...
        try {
            ...
            if (responseJson == null || responseJson.isBlank()) {
                throw new CoreException(ExternalErrorType.KRX_HOLIDAY_REQUEST_FAILED);
            }
            return responseJson;
        } catch (RestClientException exception) {
            throw new CoreException(ExternalErrorType.KRX_HOLIDAY_REQUEST_FAILED, exception);
        }
    }
    ...
    private Set<LocalDate> parseHolidayDates(String responseJson) {
        try {
            ...
            if (!holidayNodes.isArray()) {
                throw new CoreException(ExternalErrorType.KRX_HOLIDAY_RESPONSE_PARSE_FAILED);
            }
            ...
            throw new CoreException(ExternalErrorType.KRX_HOLIDAY_RESPONSE_PARSE_FAILED, exception);
        }
    }
}
