...
export default function MarketDetailRealtimeView({
  ...
  useEffect(() => {
    const stream = new EventSource(
      `/proxy-futures/markets/${encodeURIComponent(initialMarket.symbol)}/stream`
    );
    ...
    <div className="px-main-2 pb-24 flex flex-col gap-8">
      <section className="grid grid-cols-[1.5fr_0.9fr] gap-main-2 pt-4">
        <div className="rounded-main bg-white p-main-2 shadow-sm border border-main-light-gray">
          ...
          <div className="mt-6 rounded-main bg-main-light-gray/40 p-main-2 min-h-[360px] flex flex-col justify-between">
            <div>
        ...
        <aside className="rounded-main bg-white p-main-2 shadow-sm border border-main-light-gray flex flex-col gap-5">
          <div>
