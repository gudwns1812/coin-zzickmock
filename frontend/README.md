...
- `NEXT_PUBLIC_FUTURES_API_BASE_URL`: optional browser-visible override for direct public market SSE. 설정하지 않으면 `next.config.ts`가 `FUTURES_API_BASE_URL` 값을 브라우저용으로 주입한다.
